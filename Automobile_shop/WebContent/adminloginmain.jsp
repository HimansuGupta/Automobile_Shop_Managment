...
<form action="AdminAuthentication" name="myform" method="get" onsubmit="return validateform()">
<br/>  <br/>
<center style="font-size:27px;"><b>Administrator Login Details</b>
<br/>  <br/>
<table>
<tr>
<td>UserName</td>
